...
public class RefreshSession {
    ...
    public RefreshSession(String id, Long userId, String hash, Instant expiresAt) {
        this.id = id; this.userId = userId; tokenHash = hash; this.expiresAt = expiresAt;
    }
    public boolean active() { return !revoked && expiresAt.isAfter(Instant.now()); }
    public void rotate(String hash) { tokenHash = hash; }
